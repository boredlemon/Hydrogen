...
void viperT_caltagMethods (viper_State *L, const TValue *f, const TValue *p1,
...
void viperT_caltagMethodsres (viper_State *L, const TValue *f, const TValue *p1,
...
static int callbinTM (viper_State *L, const TValue *p1, const TValue *p2,
  ...
  if (notm(tm)) return 0;
  viperT_caltagMethodsres(L, tm, p1, p2, res);
  return 1;
}
